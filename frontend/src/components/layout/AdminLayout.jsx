...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      <aside className="hidden w-64 flex-shrink-0 border-r border-slate-200 bg-white/80 backdrop-blur sm:block">
        <div className="flex items-center justify-between px-6 py-4">
          <Link to="/admin/dashboard" className="text-lg font-semibold text-primary-600">
            Student Admin
          </Link>
        </div>
